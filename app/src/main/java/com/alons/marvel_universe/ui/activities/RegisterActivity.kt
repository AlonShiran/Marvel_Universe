...
class RegisterActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // View Bindings
        etEmail = binding.etEmailAddress
        etLastName = binding.etUserLastName
        etFirstName = binding.etUserFirstName
        etConfPass = binding.etConfirmPassword
    ...
    private fun signUpUser() {
        ...
        if (firstname.isBlank() || lastname.isBlank() || email.isBlank() || pass.isBlank() || confirmPassword.isBlank()) {
            Toast.makeText(this, "can't leave an empty field", Toast.LENGTH_SHORT).show()
            return
        }
